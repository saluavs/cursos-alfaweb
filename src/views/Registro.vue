<template>
  <v-container>
    <h1 class="mt-15">Registro de Usuario</h1>
    <div>
        ...
        firebase
          ...
          .catch(() => {
            Swal.fire({
              icon: 'error',
              text:
                'Ups, este E-mail ya está registrado. ¡Vuelve a intentarlo!',
            })
          })
      } else {
        Swal.fire({
          icon: 'error',
          text: 'Los datos ingresados no son válidos. ¡Vuelve a intentarlo!',
        })
      }
    },
    reset() {
